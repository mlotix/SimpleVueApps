var app = new Vue({
  ...
  data: {
    ...
    index:0,
    image: [{link:'./img/img1.jpg', alt:'obraz karmy'},
            {link:'./img/img2.png', alt:'obraz kota z karma'}],
    shortDesc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation",
    ...
    stock: 10,
    price: 49,
    attrs: ["Waga:10kg","80% miesa", "bla bla"]
  }
})
